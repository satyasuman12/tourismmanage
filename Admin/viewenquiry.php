...
<div style="padding-top:100px; box-shadow:1px 1px 20px black; height:100vh" class="container">
...
<td style="font-size:15px; padding:5px; font-weight:bold;">Query</td>
<?php

$s="select * from enquiry_details";
