...
{
	$cn=makeconnection();
	$s="delete from place_details  where Place_id='" . $_POST["t1"] . "'";
	mysqli_query($cn,$s);
	mysqli_close($cn);
	echo "<script>alert('Place Details Deleted');</script>";
    }
?>
...
<tr><td colspan="2" class="toptd">Delete Places</td></tr>
<tr><td class="lefttxt">Select Place</td><td><select name="t1" required/><option value="">Select</option>
